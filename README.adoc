...
* (_Work-in-progress_) link:literature-review/politics.adoc[*Contemporary political theory and the possibilities within crowdfunding*]: Theoretical review on politics
